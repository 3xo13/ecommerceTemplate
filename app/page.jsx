        ...
        <main className=" min-h-screen col items-center justify-between p-24">
            <section className="hero w-screen h-[75vh] flex-row-center">
                ...
                <div className="w-7/12 h-full p-10 ">
                    <div className="w-full h-4/6 p-10 col  items-end justify-center gap-5">
                        ...
                        <div className="w-full flex flex-row items-center justify-end gap-5 mt-10">
                            <input
                                ...
                                name="search"
                                id="search-home"
                                className="w-72 h-8 rounded-xl bg-white/80 focus:outline-0 px-5 border-2 drop-shadow-lg"/>
                            <button>
                                <img
                                    src="/assets/icons/general/search.svg"
                                    alt="icon"
                                    className="w-8 h-6 drop-shadow-lg"/>
                            </button>
                        </div>
                    </div>
                </div>
